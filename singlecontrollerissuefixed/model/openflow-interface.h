...
protected:
  ...
  typedef std::map<Mac48Address, LearnState_t> LearnStateSwitchMap_t;//added by @agm@ 06032019
  typedef std::map<Mac48Address, uint32_t > LastbroadcastportMap_t;//added by @agm@ 14032019
  typedef std::map<Mac48Address, std::set<uint32_t> > PortList_t;
  typedef std::set<Mac48Address> SlowSwitchList_t;//added by @agm@ 03042019
  LearnStateSwitchMap_t m_LearnStateSwitchMap,m_LearnStateSwitchMapSlow;//added by @agm@ 06032019
