...
protected:
  ...
  typedef std::map<Ptr<OpenFlowSwitchNetDevice>, LearnState_t> LearnStateSwitchMap_t;//added by @agm@ 06032019
  typedef std::map<Ptr<OpenFlowSwitchNetDevice>, uint32_t > LastbroadcastportMap_t;//added by @agm@ 14032019
